...
bedrooms = st.number_input("Bedrooms", min_value=0.0, max_value=10.0, step=1.0)
bathrooms = st.number_input("Bathrooms", min_value=0.0, max_value=10.0, step=1.0)
...
if st.button("Predict House Price"):
  input_df = pd.DataFrame([[area_sqft, bedrooms, bathrooms, age_years, distance]], columns=X.columns)
